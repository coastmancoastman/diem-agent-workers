...
Keep local payments off and treasury execution disabled. Never put real credentials, wallet keys, seed phrases, request bodies, provider bodies, prompt lengths, token counts, request IDs, network addresses, payment identities, or transaction hashes in issues, fixtures, logs, commits, or pull requests.
