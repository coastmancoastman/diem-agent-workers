...
- Sets the initial software ceiling to 0.25 DIEM of conservatively reserved work per UTC day, below the 1.69 DIEM provider-key backstop.
...
- `TREASURY_MODE=disabled` remains the production setting.
